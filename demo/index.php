...
<main class="grid grid--container">
      ...
      <div class="col">
        ...
        <article>
          ...
          <p>
            ...
            harum modi nesciunt nihil non obcaecati placeat quae quia quo ratione sequi voluptas! Architecto facilis
            quasi
            suscipit.
          </p>
        </article>
        <article>
          ...
          <div class="row demo-semantic-text-elements">
            <div class="col col--md-4"><p>
  ...
  <section id="base">
    <div class="row">
      <div class="col">
        <header class="text--center"><h3>Base</h3></header>


        <article>
          <header class="text--center"><h4>Links</h4></header>
          <div class="row">
            <div class="col">
              <p>
                Lorem ipsum <a href="http://www.googld.de">dolor</a> sit amet, consectetur adipisicing elit. At
                autem error eveniet incidunt modi nobis
                provident quasi sit tempore, vero. Autem blanditiis corporis, eligendi impedit laboriosam modi natus
        ...
        <article>
          <header class="text--center"><h4>Horizontal Rule</h4></header>
          <div class="row">
            <div class="col">
              <p>
                Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut
                labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et
                ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est ipsum dolor sit amet.
              </p>
              <hr>
              <p>
                Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut
        ...
        <article>
          <header class="text--center"><h4>Table</h4></header>
          <div class="row">
            <div class="col">
              <table>
        ...
        <article>
          <header class="text--center"><h4>Form</h4></header>
          <div class="row">
            <div class="col">
              <form>
                <div>
                ...
                <label for="checkbox1">Choice A<input id="checkbox1" name="checkbox" type="checkbox"
                                                      checked="checked"></label>

                <label for="radio1">Option 1<input id="radio1" name="radio" type="radio" checked="checked">
                ...
                <fieldset>
                  ...
                  <input id="text" type="text" placeholder="Text Input">
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque culpa delectus eaque laudantium
                    molestiae nostrum odit porro, quaerat qui reiciendis. Debitis in ipsam molestiae nulla quisquam
                    rerum sed! Fuga, sapiente.
                  </p>
                </fieldset>
              </form>
            </div>
